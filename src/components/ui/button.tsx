...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // Primary CTA - High contrast, maximum visibility
        default: "bg-accent text-accent-foreground shadow-md hover:bg-accent/90 hover:shadow-lg active:scale-[0.98]",
      ...
      size: {
        default: "h-12 px-6 py-3 text-[1rem]",
        sm: "h-10 rounded-lg px-4 text-[0.9375rem]",
        lg: "h-14 rounded-lg px-10 text-[1.125rem] [&_svg]:size-5",
        icon: "h-12 w-12",
      },
    },
    defaultVariants: {
