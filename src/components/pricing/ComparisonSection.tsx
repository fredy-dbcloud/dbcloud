...
const comparisonData = {
  en: {
    ...
    dimensions: [
      ...
      },
      {
        ...
        dbcloud: "Pre-built, battle-tested",
        inhouse: "Build from scratch",
        dbcloudBetter: true,
      },
      {
        label: "Scalability",
      ...
      },
      {
        ...
        dbcloud: "Minimal — we handle it",
        inhouse: "You manage performance & retention",
        dbcloudBetter: true,
      },
    ],
  ...
  es: {
    ...
    dimensions: [
      ...
      {
        label: "Herramientas y Automatización",
        dbcloud: "Pre-construidas y probadas",
        inhouse: "Construir desde cero",
        dbcloudBetter: true,
      },
      {
        label: "Escalabilidad",
      ...
      {
        label: "Carga de Gestión",
        dbcloud: "Mínima — nosotros lo manejamos",
        inhouse: "Tú gestionas rendimiento y retención",
        dbcloudBetter: true,
      },
    ],
