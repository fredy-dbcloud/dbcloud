export const translations = {
  en: {
    ...
    contact: {
      ...
      scheduleHelper: "30-minute call · No sales pressure",
      formFilter: "Best for SMBs with live or growing cloud workloads.",
      interests: {
  ...
  es: {
    ...
    contact: {
      ...
      scheduleHelper: "Llamada de 30 minutos · Sin presión de venta",
      formFilter: "Ideal para PYMEs con cargas cloud activas o en crecimiento.",
      interests: {
